...
export default class TelegramBot {
  ...
  async #get(method: string, parameters: Parameters = {}): Promise<Result> {
  ...
  async #post(method: string, body: string | FormData): Promise<Result> {
  ...
  getUpdates(parameters: GetUpdateParameters): Promise<Update[]> {
  ...
  sendVideo(parameters: SendVideoParameters): Promise<Message> {
